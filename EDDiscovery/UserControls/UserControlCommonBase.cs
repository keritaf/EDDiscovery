...
namespace EDDiscovery.UserControls
{
    public class UserControlCommonBase : UserControl
    {
        ...
        protected int
            DisplayNumberOfGrid(
                int numopenedinside) // grid children are assigned this range..  allow range for splitters.
        {
        ...
        {
        } // start up, called by above Init.  no cursor available
        ...
        {
        } // then a chance to load a layout. cursor available
        ...
        public virtual Color ColorTransparency
        {
            get { return Color.Transparent; }
        } // override to say support transparency, and what colour you want.

        public bool IsFloatingWindow
        {
            get { return this.FindForm() is Forms.UserControlForm; }
        } // ultimately its a floating window
        ...
        public void SetControlText(string s) // used to set heading text in either the form of the tabstrip
        {
            ...
            {
                case TabStrip strip:
                    strip.SetControlText(s);
                    break;
                case UserControlForm form:
                    form.SetControlText(s);
                    break;
                case UserControlContainerResizable resizable:
                    resizable.SetControlText(s);
                    break;
            }
        }
        ...
        {
            return (this.Parent is ExtendedControls.TabStrip) || (this.Parent is Forms.UserControlForm) ||
                   (this.Parent is UserControlContainerResizable);
        }
        ...
        public bool
            ResizingNow = false; // FUNCTIONS to allow a form to grow temporarily.  Does not work when inside the panels
        ...
        public bool IsInTemporaryResize // have we grown?
        {
            get
            {
                return (this.Parent is Forms.UserControlForm)
                    ? ((Forms.UserControlForm) (this.Parent)).IsTemporaryResized
                    : false;
            }
        }
            ...
            if (SQLiteConnectionUser.keyExists(root + "1")) // if stored values, set back to what they were..
            {
                ...
                else
                {
                    using (Graphics g = dgv.CreateGraphics())
                    {
                        ...
                        dgv.RowHeadersWidth =
                            (int) (sz.Width + 6); // size it to the text, need a little more for rounding
                    }
                }
            }
        }
        ...
        private void InitializeComponent()
        {
            this.SuspendLayout();
            // 
            // UserControlCommonBase
            // 
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.Name = "UserControlCommonBase";
